...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.pockey.controller.Seller*.*(..))" +
            "&& !execution(public * com.pockey.controller.SellerUserController.*(..))")
    public void verify() {
    }

    @Before("verify()") // 在切入点执行之前操作
